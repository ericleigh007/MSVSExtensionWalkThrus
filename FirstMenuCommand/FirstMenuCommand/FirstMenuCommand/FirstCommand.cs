...
namespace FirstMenuCommand
{
    ...
    internal sealed class FirstCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("8d30de98-839d-4792-8f2e-f44c62baf8c6");
        ...
        /*  The walkthru says to remove this method, but instead we just comment it to preserve the code for documentation
